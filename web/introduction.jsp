					...
					$(function() {});
						$(window).load(function() {
							...
							$("#add").click(function(){
							    ...
							    // 获取商品的数量
							    var num =parseInt($("#value").val()); // 以为num是字符串类型

							    // 获取库存
								var gnum = "${goodsInfo.gnum}";
							...
							$("#addShopCar").click(function(){
								...
								// 3.创建一个对象，把两个参数封装到一个对象
								var param = new Object();
								param.gid = gid;
								param.count = count;

								// 4.异步发送请求交给服务端处理
								$.post("ShopServlet/addShopCar",param,function(data){
									location.reload();
								});
							});
					});
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="#"><img src="ShopServlet/getGoodsPngById?id=${goodsInfo.id}"
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						...
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${goodsInfo.gpriceOff}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${goodsInfo.gprice}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													...
													<span class="stock" id="stock">${goodsInfo.gnum}</span>件
													</span>
												</dd>
