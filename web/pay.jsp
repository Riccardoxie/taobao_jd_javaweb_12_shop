			...
			$(function(){
				...
				$("ul[class='addressChoose'] li").each(function(){
						...
						$(this).click(function(){
							...
							// 获取用户地址的售后地址信息
							var user = $("li[class='user-addresslist defaultAddr'] span[class='buy-user']").text();
							var phone = $("li[class='user-addresslist defaultAddr'] span[class='buy-phone']").text();
							var address = $("li[class='user-addresslist defaultAddr'] span[class='buy-address']").text();
					...
					$("ul[class='op_express_delivery_hot'] li").each(function(){
						$(this).unbind(); // 取消当前元素绑定的时间

						$(this).click(function(){ // 给当元素添加点击事件
				...
				// 获取到了用户的默认地址
				var defAddress = $("#def_1");

				// 选中默认地址
                defAddress.attr("class","user-addresslist defaultAddr");

                ﻿
				defAddress.find(".address-left").append("<ins class=\"deftip\">默认地址</ins>");
	...
	<%@include file="head.jsp" %>
			<div class="concent">
				...
				<div class="paycont">
					<div class="address">
						...
						<ul class="addressChoose">
								...
								<c:forEach items="${userAddressList}" var="address">
									...
									<li class="user-addresslist" id="def_${address.isDef}">
										<div class="address-left">
											...
											<div class="default-address DefaultAddr">
												...
												<span class="buy-address">${address.address}</span>
											</div>
					...
					<c:forEach items="${sessionScope.shop_car.list}" var="domain">
							<!-- 购物车 -->
							<tr class="item-list">
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="ShopServlet/getGoodsPngById?id=${domain.id}" style="width: 80px; height: 80px" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${domain.gname}</a>
														</div>
													</div>
												</li>						
													...
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<div class="price-line">
																<em class="price-original">${domain.gpriceOff}</em>
															</div>
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow" tabindex="0">${domain.gprice}</em>
															</div>
														</div>
													</div>
												</li>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice">
														<fmt:formatNumber value="${domain.gpriceOff*domain.count}" pattern="#.###"/>
													</em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><fmt:formatNumber value="${sessionScope.shop_car.totalPrice}" pattern="#.##"/></em>
											</span>
										</div>
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="ShopServlet/addOrder" method="post" id="form">
											<input type="hidden" name="name" value="" id="buy_user"/>
											<input type="hidden" name="phone" value="" id="phone"/>
											<input type="hidden" name="address" value="" id="address"/>
											<input type="hidden" name="sendType" value="" id="express"/>
