		...
		<div class="login-main">
			...
			<div class="login-box">
				...
				<div class="login-form">
					<form  method="post" id ="login_from" action="CustomerServlet/login">
						<div class="user-name">
							<label ><i class="am-icon-user"></i></label> <input
								type="text" name="username" value="admin" id="username" placeholder="邮箱/手机/用户名">
						</div>
						<div class="user-pass">
							<label for="password"><i class="am-icon-lock"></i></label> <input
								type="password"  value="admin" name="password" id="password" placeholder="请输入密码">
						</div>
					</form>
				</div>
				...
				<div class="am-cf">
					<input type="submit" id="user_login" value="登 录"
