...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!--
		·base是一个全局的设置,设置base标签后当前页面发出的请求(js,css,image)前面都会加上base中href的内容
		 -->
					   ...
					   <div class="nav-cont">
						...
						<div id="nav" class="navfull">
							<div class="area clearfix">
								...
								<c:if test="${big.gpid eq '0'}">
									<div class="category">
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/${big.gpng}"></i><a class="ml-22" title="点心">${big.gname}</a></h3>
													<em>&gt;</em></div>
														...
														<div class="area-bg">
															<div class="menu-srot">									
																...
																<c:forEach items="${gtList}" var="small">	
																	<c:if test="${big.id eq small.gpid}">
																	<dl class="dl-sort">															
																		<dt><span title="${small.gname}">${small.gname}</span></dt>
																		<c:forEach items="${giList}" var="info">
																		<c:if test="${small.id eq info.gfid}">
																		<dd><a title="${info.gname}" href="ShopServlet/getGoodsInfoById?id=${info.id}"><span>${info.gname}</span></a></dd>
																		</c:if>	
																		</c:forEach>	
																	</dl>
																	</c:if>	
					...
					<div class="am-g am-g-fixed floodFour">
						...
						<c:forEach items="${giList}" var="info">
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="GoodsInfoServlet?method=queryById&id=${info.id}"><img src="images/${info.gpng}" style="width: 160px;height:160px " /></a>
							</div>
							</c:if>
							</c:forEach>				
                 	</div>
